...
local installation_path = fn.stdpath("data") .. "/lazy/lazy.nvim"
...
-- add to runtime path
vim.opt.rtp:prepend(installation_path)
...
-- plugins: dict or str
-- opts: check https://github.com/folke/lazy.nvim?tab=readme-ov-file#%EF%B8%8F-configuration
